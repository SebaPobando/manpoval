...
window.addEventListener('DOMContentLoaded', event => {
    ...
    // Función para detener videos de YouTube en los modales al cerrarlos
    const stopYouTubeVideos = () => {
        const modales = document.querySelectorAll('.portfolio-modal');
    ...
    // Llamar a la función para detener videos
    stopYouTubeVideos();
